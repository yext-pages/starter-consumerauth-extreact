 ...
 * @public
 */
export declare type CardAnalyticsDataType<T = DefaultRawDataType> = DirectAnswer_2 | Result<T>;
 ...
 */
declare function Geolocation_2({ geolocationOptions, radius, label, GeolocationIcon, handleClick, customCssClasses, }: GeolocationProps): JSX.Element | null;
