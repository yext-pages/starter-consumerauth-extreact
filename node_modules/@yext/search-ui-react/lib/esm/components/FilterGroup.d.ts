 ...
 */
export declare function FilterGroup({ fieldId, filterOptions, title, collapsible, defaultExpanded, searchable, customCssClasses, showMoreLimit, children }: PropsWithChildren<FilterGroupProps>): JSX.Element;
