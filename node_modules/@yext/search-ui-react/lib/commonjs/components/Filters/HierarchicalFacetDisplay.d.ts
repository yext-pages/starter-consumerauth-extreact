...
export declare const DEFAULT_HIERARCHICAL_DELIMITER = ">";
/**
 ...
 * @public
 */
export declare function HierarchicalFacetDisplay({ facet, delimiter, showMoreLimit, customCssClasses }: HierarchicalFacetDisplayProps): JSX.Element;
//# sourceMappingURL=HierarchicalFacetDisplay.d.ts.map