...
exports.HierarchicalFacetDisplay = exports.DEFAULT_HIERARCHICAL_DELIMITER = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const useComposedCssClasses_1 = require("../../hooks/useComposedCssClasses");
const useHierarchicalFacetTree_1 = require("../../hooks/useHierarchicalFacetTree");
const FiltersContext_1 = require("./FiltersContext");
exports.DEFAULT_HIERARCHICAL_DELIMITER = '>';
 ...
 * @public
 */
function HierarchicalFacetDisplay({ facet, delimiter = exports.DEFAULT_HIERARCHICAL_DELIMITER, showMoreLimit = 4, customCssClasses }) {
    const cssClasses = (0, useComposedCssClasses_1.useComposedCssClasses)(builtInCssClasses, customCssClasses);
    const tree = (0, useHierarchicalFacetTree_1.useHierarchicalFacetTree)(facet, delimiter);
    const [isShowingMore, setIsShowingMore] = (0, react_1.useState)(false);
    const resetShowMore = (0, react_1.useCallback)(() => setIsShowingMore(false), []);
    const toggleShowMore = (0, react_1.useCallback)(() => {
    ...
    function renderAllCategoriesButton() {
        return ((0, jsx_runtime_1.jsx)(AllCategories, { activeClassName: cssClasses.allCategoriesOption___active, inactiveClassName: cssClasses.allCategoriesOption___inactive, facet: facet, resetShowMore: resetShowMore }, '_AllCategories'));
    }
    function renderAvailableOptions(nodes) {
        const nodesToRender = isShowingMore ? nodes : nodes.slice(0, showMoreLimit);
        return nodesToRender.map(n => (0, jsx_runtime_1.jsx)(AvailableOption, { activeClassName: cssClasses.availableOption__active, inactiveClassName: cssClasses.availableOption__inactive, fieldId: facet.fieldId, currentNode: n, resetShowMore: resetShowMore, siblingNodes: nodes.filter(siblingNode => siblingNode !== n) }, n.lastDisplayNameToken));
    }
    function renderShowMoreButton() {
        return (0, jsx_runtime_1.jsx)(ShowMoreButton, { className: cssClasses.showMoreButton, isShowingMore: isShowingMore, toggleShowMore: toggleShowMore }, '_ShowMoreButton');
    }
    function renderCategory(selectedNode, fieldId) {
        ...
        if (selectedNode.hasSelectedChild) {
            return (0, jsx_runtime_1.jsx)(ParentCategory, Object.assign({ className: cssClasses.parentCategory }, sharedProps), void 0);
        }
        else {
            return (0, jsx_runtime_1.jsx)(CurrentCategory, Object.assign({ className: cssClasses.currentCategory }, sharedProps), void 0);
        }
    }
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: cssClasses.treeContainer }, { children: renderTree() }), void 0));
}
exports.HierarchicalFacetDisplay = HierarchicalFacetDisplay;
/**
...
function AllCategories({ facet, inactiveClassName, activeClassName, resetShowMore }) {
    const { applyFilters, selectFilter } = (0, FiltersContext_1.useFiltersContext)();
    const handleClickAllCategories = (0, react_1.useCallback)(() => {
        facet.options
            .filter(o => o.selected)
    ...
    if (facet.options.find(o => o.selected)) {
        return ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: inactiveClassName, onClick: handleClickAllCategories }, { children: "All Categories /" }), void 0));
    }
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: activeClassName }, { children: "All Categories" }), void 0));
}
...
function AvailableOption(props) {
    ...
    const handleClickAvailableOptions = (0, react_1.useCallback)(() => {
        var _a;
    ...
    return ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: selected ? activeClassName : inactiveClassName, onClick: handleClickAvailableOptions }, { children: lastDisplayNameToken }), void 0));
}
/** A parent category that is not the most immediate one. */
function ParentCategory({ fieldId, selectedNode, className, resetShowMore }) {
    const { applyFilters, selectFilter } = (0, FiltersContext_1.useFiltersContext)();
    const deselectChildOptions = (0, react_1.useCallback)((node) => {
    ...
    const handleClickParentCategory = (0, react_1.useCallback)(() => {
    ...
    return ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: className, onClick: handleClickParentCategory }, { children: selectedNode.lastDisplayNameToken + ' /' }), void 0));
}
...
function CurrentCategory({ fieldId, selectedNode, className, resetShowMore }) {
    var _a;
    const { applyFilters, selectFilter } = (0, FiltersContext_1.useFiltersContext)();
    const handleClickCurrentCategory = (0, react_1.useCallback)(() => {
        var _a;
    ...
    return ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: className, onClick: handleClickCurrentCategory }, { children: selectedNode.lastDisplayNameToken }), void 0));
}
...
function ShowMoreButton({ className, isShowingMore, toggleShowMore }) {
    return ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: className, onClick: toggleShowMore }, { children: isShowingMore ? 'Show less' : 'Show more' }), void 0));
}
