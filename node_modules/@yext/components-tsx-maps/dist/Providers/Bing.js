 ...
 */
class BingMap extends ProviderMap_js_1.ProviderMap {
    /**
    ...
    constructor(options) {
        ...
        this.map = new Microsoft.Maps.Map(this.wrapper, Object.assign({ disablePanning: !options.controlEnabled, disableZooming: !options.controlEnabled, showLocateMeButton: false, showMapTypeSelector: false, showScalebar: false, showTrafficButton: false }, options.providerOptions));
 ...
 */
class BingPin extends ProviderPin_js_1.HTMLProviderPin {
    /**
...
function load(resolve, reject, apiKey, { params = {} } = {}) {
    ...
    const apiParams = Object.assign({ callback: globalCallback, key: apiKey }, params);
 ...
 */
const BingMaps = new MapProvider_js_1.MapProviderOptions()
