...
exports.gcj02ToBD09 = exports.BaiduMaps = void 0;
    ...
    return await new Promise((resolve, reject) => {
        ...
        function sendRequests() {
            ...
            window[callback] = data => {
                ...
                const convertedCoords = data.result.map(point => new components_tsx_geo_1.Coordinate(point.y, point.x));
                let currentIndex = 0;
 ...
 */
class BaiduMap extends ProviderMap_js_1.ProviderMap {
    /**
    ...
    constructor(options) {
        ...
        this.map = new BMap.Map(this._wrapper, Object.assign({ enableMapClick: options.controlEnabled, 
            ...
            maxZoom: isIE11 ? 14 : 18 }, options.providerOptions));
 ...
 */
class BaiduPin extends ProviderPin_js_1.HTMLProviderPin {
    /**
...
function load(resolve, reject, apiKey, { params = {}, version = '3.0' } = {}) {
    ...
    const key = apiKey;
    const apiParams = Object.assign({ ak: key, v: version }, params);
    resolveAPIKey(key);
    const script = document.createElement('script');
