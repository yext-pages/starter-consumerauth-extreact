 ...
 */
class LeafletMap extends ProviderMap_js_1.ProviderMap {
    /**
    ...
    _initMap(options) {
        ...
        this.map = new L.map(options.wrapper, Object.assign({ boxZoom: options.controlEnabled, doubleClickZoom: options.controlEnabled, dragging: options.controlEnabled, zoom: 0, zoomControl: options.controlEnabled, zoomSnap: 0 }, options.providerOptions));
 ...
 */
class LeafletPin extends ProviderPin_js_1.ProviderPin {
    /**
 ...
 */
const LeafletMaps = new MapProvider_js_1.MapProviderOptions()
