...
module.exports = __webpack_require__(6209);
...
var _Symbol$iterator = __webpack_require__(3882);
...
var _defineProperty = _interopRequireDefault(__webpack_require__(3978));
...
var _SearchCore = __webpack_require__(1560);

var _provideCore = __webpack_require__(1385);

var _provideEndpoints = __webpack_require__(1944);
...
var _getClientSdk = __webpack_require__(6722);

var _serializeFilterSearch = __webpack_require__(4634);
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            if (!('token' in this.config)) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , this.httpService.get(this.universalEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.get(this.universalEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.httpService.get(this.verticalEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.get(this.verticalEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.httpService.get(this.filterEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.get(this.filterEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
...
var _concat = _interopRequireDefault(__webpack_require__(7766));
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.httpService.post(this.endpoint, queryParams, body, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.post(this.endpoint, queryParams, body, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
...
function () {
        ...
        switch (_f.label) {
          case 0:
            queryParams = __assign(__assign(__assign({
              ...
              v: _provideEndpoints.defaultApiVersion,
              version: this.config.experienceVersion,
              limit: (0, _stringify.default)(request.limit),
              ...
              context: (0, _stringify.default)(request.context),
              referrerPageUrl: request.referrerPageUrl,
              source: request.querySource || _QuerySource.QuerySource.Standard,
              visitorId: (_a = this.config.visitor) === null || _a === void 0 ? void 0 : _a.id,
              visitorIdMethod: (_b = this.config.visitor) === null || _b === void 0 ? void 0 : _b.idMethod,
              restrictVerticals: (_c = request.restrictVerticals) === null || _c === void 0 ? void 0 : _c.join(',')
            }), (_d = this.config) === null || _d === void 0 ? void 0 : _d.additionalQueryParams);
            if (!('token' in this.config)) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , this.httpService.get(this.universalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.get(this.universalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
        ...
        switch (_f.label) {
          case 0:
            queryParams = __assign(__assign(__assign({
              ...
              location: this.stringifyLatLong(request.location),
              verticalKey: request.verticalKey,
              filters: request.staticFilter && (0, _serializeStaticFilters.serializeStaticFilters)(request.staticFilter),
              limit: request.limit,
              ...
              referrerPageUrl: request.referrerPageUrl,
              source: request.querySource || _QuerySource.QuerySource.Standard,
              locationRadius: (_a = request.locationRadius) === null || _a === void 0 ? void 0 : _a.toString(),
              queryId: request.queryId,
              visitorId: (_b = this.config.visitor) === null || _b === void 0 ? void 0 : _b.id,
              visitorIdMethod: (_c = this.config.visitor) === null || _c === void 0 ? void 0 : _c.idMethod
            }), (_d = this.config) === null || _d === void 0 ? void 0 : _d.additionalQueryParams);
            if (!('token' in this.config)) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , this.httpService.get(this.verticalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          ...
          case 2:
            return [4
            /*yield*/
            , this.httpService.get(this.verticalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
  ...
  SearchServiceImpl.prototype.stringifyLatLong = function (latLong) {
    ...
    return (0, _concat.default)(_context = "".concat(latLong.latitude, ",")).call(_context, latLong.longitude);
  };
...
var _exportNames = {
  ...
  SortType: true,
  Direction: true,
  AppliedQueryFilterType: true,
  DirectAnswerType: true,
  BuiltInFieldType: true,
...
_Object$defineProperty(exports, "AppliedQueryFilterType", {
  enumerable: true,
  get: function get() {
    return _AppliedQueryFilterType.AppliedQueryFilterType;
  }
});

_Object$defineProperty(exports, "BuiltInFieldType", {
  enumerable: true,
  get: function get() {
    return _BuiltInFieldType.BuiltInFieldType;
  }
});

_Object$defineProperty(exports, "CloudRegion", {
  enumerable: true,
  get: function get() {
    return _CloudRegion.CloudRegion;
  }
});
...
_Object$defineProperty(exports, "Environment", {
  enumerable: true,
  get: function get() {
...
_Object$defineProperty(exports, "ErrorType", {
  enumerable: true,
  get: function get() {
    return _ErrorType.ErrorType;
  }
});
...
_Object$defineProperty(exports, "FilterCombinator", {
  enumerable: true,
  get: function get() {
    return _StaticFilter.FilterCombinator;
  }
});
...
_Object$defineProperty(exports, "SearchError", {
  enumerable: true,
  get: function get() {
    return _SearchError.SearchError;
  }
});
...
var _SearchError = __webpack_require__(299);

var _Environment = __webpack_require__(5441);

var _CloudRegion = __webpack_require__(7135);
...
var _StaticFilter = __webpack_require__(3150);
...
var _AppliedQueryFilterType = __webpack_require__(3536);

var _DirectAnswerType = __webpack_require__(9210);

var _BuiltInFieldType = __webpack_require__(2627);

var _fieldvaluedirectanswers = __webpack_require__(9338);

_forEachInstanceProperty(_context3 = _Object$keys(_fieldvaluedirectanswers)).call(_context3, function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _fieldvaluedirectanswers[key]) return;

  _Object$defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _fieldvaluedirectanswers[key];
    }
  });
});

var _featuredsnippetdirectanswers = __webpack_require__(309);

_forEachInstanceProperty(_context4 = _Object$keys(_featuredsnippetdirectanswers)).call(_context4, function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _featuredsnippetdirectanswers[key]) return;

  _Object$defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _featuredsnippetdirectanswers[key];
    }
  });
});
...
var _ErrorType = __webpack_require__(98);
...
function (_super) {
  ...
  function SearchError(message, code, type) {
    ...
    _this.code = code;
    _this.type = type; // When targeting ES5, it is necessary to manually set the prototype for instance of checks to work
    // See: "Extending built-ins like Error, Array, and Map may no longer work"
    // https://github.com/Microsoft/TypeScript/wiki/Breaking-Changes

    (0, _setPrototypeOf.default)(_this, SearchError.prototype);
    return _this;
  }
...
var _typeof2 = _interopRequireDefault(__webpack_require__(3765));

function isNumberRangeValue(data) {
  return (0, _typeof2.default)(data) === 'object' && !!data && ('start' in data || 'end' in data);
}
...
exports.AppliedQueryFilterType = void 0;
...
exports.AppliedQueryFilterType = AppliedQueryFilterType;
...
})(AppliedQueryFilterType || (exports.AppliedQueryFilterType = AppliedQueryFilterType = {}));
...
exports.BuiltInFieldType = void 0;
...
exports.BuiltInFieldType = BuiltInFieldType;

(function (BuiltInFieldType) {
  BuiltInFieldType["URL"] = "url";
  BuiltInFieldType["ComplexURL"] = "complex_url";
  BuiltInFieldType["IOSAppURL"] = "ios_app_url";
  BuiltInFieldType["AndroidAppURL"] = "android_app_url";
  BuiltInFieldType["FacebookURL"] = "facebook_url";
  BuiltInFieldType["Email"] = "email";
  BuiltInFieldType["InstagramHandle"] = "instagram_handle";
  BuiltInFieldType["TwitterHandle"] = "twitter_handle";
  BuiltInFieldType["Phone"] = "phone";
  BuiltInFieldType["Address"] = "address";
  BuiltInFieldType["Hours"] = "hours";
  BuiltInFieldType["Decimal"] = "decimal";
  BuiltInFieldType["Integer"] = "integer";
  BuiltInFieldType["SingleLineText"] = "single_line_text";
  BuiltInFieldType["RichText"] = "rich_text";
  BuiltInFieldType["MultiLineText"] = "multi_line_text";
})(BuiltInFieldType || (exports.BuiltInFieldType = BuiltInFieldType = {}));
...
function provideCore(config) {
  ...
  var defaultedConfig = __assign(__assign({}, config), {
    endpoints: __assign(__assign({}, new _provideEndpoints.EndpointsFactory(config).getEndpoints()), config.endpoints)
  });
  ...
  var searchService = new _SearchServiceImpl.SearchServiceImpl(defaultedConfig, httpService, apiResponseValidator);
  var questionSubmissionService = new _QuestionSubmissionServiceImpl.QuestionSubmissionServiceImpl(defaultedConfig, httpService, apiResponseValidator);
  var autoCompleteService = new _AutocompleteServiceImpl.AutocompleteServiceImpl(defaultedConfig, httpService, apiResponseValidator);
  return new _SearchCore.SearchCore(searchService, questionSubmissionService, autoCompleteService);
}
...
exports.defaultApiVersion = exports.SandboxEndpoints = exports.EndpointsFactory = void 0;
...
var EndpointsFactory =
/** @class */
function () {
  function EndpointsFactory(config) {
    this.environment = (config === null || config === void 0 ? void 0 : config.environment) || _Environment.Environment.PROD;
    this.cloudRegion = (config === null || config === void 0 ? void 0 : config.cloudRegion) || _CloudRegion.CloudRegion.US;
  }
  ...
  EndpointsFactory.prototype.getDomain = function () {
    ...
    return (0, _concat.default)(_context = "https://".concat(this.environment, "-cdn.")).call(_context, this.cloudRegion, ".yextapis.com");
  };
 ...
 * @public
 */
var SandboxEndpoints = new EndpointsFactory({
  environment: _Environment.Environment.SANDBOX,
  cloudRegion: _CloudRegion.CloudRegion.US
}).getEndpoints();
...
function shapeFacetOptionArrayForApi(options, fieldId) {
  return (0, _map.default)(options).call(options, function (option) {
    return (0, _serializeStaticFilters.shapeFieldValueFilterForApi)(__assign(__assign({}, option), {
      fieldId: fieldId
    }));
  });
}
...
exports.serializeExcludedFields = serializeExcludedFields;
exports.serializeSearchParameterFields = serializeSearchParameterFields;
...
function serializeExcludedFields(excludedFields) {
  return excludedFields === null || excludedFields === void 0 ? void 0 : (0, _map.default)(excludedFields).call(excludedFields, function (_a) {
    var _b, _c;
...
var _NumberRangeValue = __webpack_require__(6800);
...
function serializeStaticFilters(filter) {
  if (filter.kind !== 'fieldValue') {
    ...
    return shapedFilter && (0, _stringify.default)(shapedFilter);
  }

  return (0, _stringify.default)(shapeFieldValueFilterForApi(filter));
}
...
function shapeCombinedFilterForApi(combinator, filters) {
  ...
  return shapedFilters.length === 0 ? undefined : shapedFilters.length === 1 ? shapedFilters[0] : (_a = {}, _a[combinator] = shapedFilters, _a);
}
...
function shapeFieldValueFilterForApi(filter) {
  ...
  if ((0, _NumberRangeValue.isNumberRangeValue)(filter.value)) {
...
function createFilterSearchResponse(data) {
  ...
  if (response.failedVerticals && response.failedVerticals.length != 0) {
    ...
    throw new _SearchError.SearchError(error.details.description, error.details.responseCode, error.errorType);
  }

  var sections = (0, _map.default)(_context2 = response.sections).call(_context2, function (section) {
    var _context3;
...
var _createFieldValueFilter = __webpack_require__(1167);
...
function createAutocompleteResult(result) {
  ...
  return {
    filter: (0, _filter.default)(result) && (0, _createFieldValueFilter.createFieldValueFilter)((0, _filter.default)(result)),
    key: result.key,
...
function createFieldValueFilter(filter) {
  ...
  if (matcher === _Matcher.Matcher.Between) {
...
function createNumberRangeValue(value) {
  ...
  (0, _forEach.default)(_context = (0, _keys.default)(value)).call(_context, function (limitMatcher) {
    if (limitMatcher === _Matcher.Matcher.GreaterThan || limitMatcher === _Matcher.Matcher.GreaterThanOrEqualTo) {
      numberRangeValue.start = {
        matcher: limitMatcher,
        value: value[limitMatcher]
      };
    } else if (limitMatcher === _Matcher.Matcher.LessThan || limitMatcher === _Matcher.Matcher.LessThanOrEqualTo) {
      numberRangeValue.end = {
        matcher: limitMatcher,
        value: value[limitMatcher]
      };
    }
...
function createAppliedQueryFilter(data) {
  return __assign({
    ...
    filter: (0, _createFieldValueFilter.createFieldValueFilter)((0, _filter.default)(data)),
    type: data.type
  }, data.details && {
...
var _includes = _interopRequireDefault(__webpack_require__(8580));

var _values = _interopRequireDefault(__webpack_require__(455));
...
function createDirectAnswer(data) {
  ...
  var commonDirectAnswerData = {
    ...
    fieldType: (0, _includes.default)(_context = (0, _values.default)(_BuiltInFieldType.BuiltInFieldType)).call(_context, data.answer.fieldType) ? data.answer.fieldType : 'unknown'
  };
  ...
  if (isFieldValueDirectAnswer) {
    ...
    if (fieldType != _BuiltInFieldType.BuiltInFieldType.MultiLineText && fieldType != _BuiltInFieldType.BuiltInFieldType.RichText) {
...
function createFacetOptions(options) {
  return (0, _map.default)(options).call(options, function (option) {
    var filter = (0, _createFieldValueFilter.createFieldValueFilter)((0, _filter.default)(option));
    return {
...
exports.createFailedVertical = createFailedVertical;
...
var _createFailedVertical = __webpack_require__(2826);
...
function createUniversalSearchResponse(data) {
  ...
  return {
    ...
    failedVerticals: (_a = data.response.failedVerticals) === null || _a === void 0 ? void 0 : (0, _map.default)(_a).call(_a, _createFailedVertical.createFailedVertical)
  };
}
...
function createVerticalSearchResponse(data) {
  ...
  return {
    ...
    alternativeVerticals: (_b = (_a = data.response.alternativeVerticals) === null || _a === void 0 ? void 0 : _a.modules) === null || _b === void 0 ? void 0 : (0, _map.default)(_b).call(_b, _createVerticalResults.createVerticalResults),
...
var _entries = _interopRequireDefault(__webpack_require__(6295));
...
function getClientSdk(additionalHttpHeaders) {
  ...
  return (0, _reduce.default)(_context = (0, _entries.default)(customClientSdk)).call(_context, function (clientSdk, _a) {
    var _b;

    var agent = _a[0],
        version = _a[1];
    return version ? __assign(__assign({}, clientSdk), (_b = {}, _b[agent] = version, _b)) : clientSdk;
  }, coreAgent);
}
...
function () {
  ...
  ApiResponseValidator.prototype.validateResponseProp = function (apiResponse) {
    if (!apiResponse.response) {
      return new _SearchError.SearchError('Malformed Search API response: missing response property.');
    }
  };

  ApiResponseValidator.prototype.validateMetaProp = function (apiResponse) {
    if (!apiResponse.meta) {
      return new _SearchError.SearchError('Malformed Search API response: missing meta property.');
    }
  };
  ...
  ApiResponseValidator.prototype.checkForApiErrors = function (apiResponse) {
    ...
    if (((_b = (_a = apiResponse.meta) === null || _a === void 0 ? void 0 : _a.errors) === null || _b === void 0 ? void 0 : _b.length) >= 1) {
      ...
      return new _SearchError.SearchError(error.message, error.code, error.type);
    }
  };
...
var inspectSource = __webpack_require__(1302);
var iterate = __webpack_require__(3091);
var checkCorrectnessOfIteration = __webpack_require__(9491);
var speciesConstructor = __webpack_require__(487);
...
/******/ 	var __webpack_exports__ = __webpack_require__(4003);
/******/ 	
